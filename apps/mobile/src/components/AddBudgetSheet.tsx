...
// (or create a new one via CategoryPickerSheet's allowCreate), set an
// amount, optionally roll over unused and/or mark it a fixed charge (skips
// the burn-rate projection, which assumes spend accrues gradually through
// the month -- doesn't apply to something like rent or insurance).
