...
const ENV_VARS: { name: string; required: boolean; description: string }[] = [
  ...
  { name: "PLAID_PRODUCTS", required: false, description: "Comma-separated, defaults to transactions." },
  { name: "PLAID_ADDITIONAL_CONSENTED_PRODUCTS", required: false, description: "Comma-separated, e.g. investments,liabilities." },
