...
const ENV_VARS: { name: string; required: boolean; description: string }[] = [
  ...
  { name: "PLAID_PRODUCTS", required: false, description: "Comma-separated, defaults to transactions,investments,liabilities. Actively requested at Link time; each is billed once an item connects." },
  { name: "PLAID_ADDITIONAL_CONSENTED_PRODUCTS", required: false, description: "Comma-separated, optional. Consented during Link but billed only once actually fetched; unused by default." },
