    ...
    <div className="max-w-[1280px] mx-auto px-8 py-7 flex flex-col gap-6">
      ...
      {streams.length === 0 ? (
        ...
        <>
          ...
          <Card>
            <div className="grid grid-cols-[minmax(180px,1fr)_140px_150px_130px_130px_120px_130px] gap-3 items-center px-4 py-2.5 bg-surface-2 border-b border-border text-xs font-medium uppercase tracking-wide text-text-3">
              <span>Merchant</span>
              <span>Category</span>
              <span>Account</span>
              <span>Cadence</span>
            ...
            {streams.map((s) => (
              <div
                key={s.id}
                className="grid grid-cols-[minmax(180px,1fr)_140px_150px_130px_130px_120px_130px] gap-3 items-center px-4 py-2.5 border-b border-border last:border-b-0"
              >
